...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            ...
            context["error"] = "Esta ruta no existe actualmente! Elige una que existe"
...
def bookings(request):
    ...
    if request.method == 'POST':
        ...
        seats_r = str(request.POST.get('no_seats'))
        ...
        if bus:
            if str(seats_r):
                ...
                context["error"] = "Lo sentimos, selecciona menos número de asientos."
                return render(request, 'myapp/findbus.html', context)
...
def cancellings(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            context["error"] = "Lo siento, no has reservado ese autobús."
...
def seebookings(request,new={}):
    ...
    if book_list:
        ...
        context["error"] = "Lo sentimos, no hay autobuses reservados."
        return render(request, 'myapp/findbus.html', context)
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            context["error"] = "Proporcionar credenciales válidas"
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        context["error"] = "Usted no se ha identificado"
        return render(request, 'myapp/signin.html', context)
...
def signout(request):
    context = {}
    logout(request)
    context['error'] = "Has sido desconectado"
    return render(request, 'myapp/signin.html', context)
